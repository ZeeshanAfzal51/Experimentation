...
if pdf_files and excel_file:
    ...
    # Define the prompt
    prompt = ("Before we begin please disregard , ignore and forget any previous context or cumulative data . the following is OCR extracted text from a single invoice PDF. "
