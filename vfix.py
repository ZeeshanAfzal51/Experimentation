...
os.environ["GEMINI_API_KEY"] = "AIzaSyC9ImFY7_XHPUcfW48Cto5RDHm6QP8vA4Y"
...
if pdf_files and excel_file:
    ...
    # Ask if the user wants to view the structured summaries
    if st.button("Would you like to view the structured summaries?"):
        for pdf_file, parameters in zip(pdf_files, all_parameters):
